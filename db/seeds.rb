Member.create!([
  ...
  {name: "Rob Cruickshank", title: "Board Member", image: "small-rob.jpg", image_big: "medium-rob.jpg"},
  {name: "Deb Cherachanko", title: "Board Member", image: "small-dab.jpg", image_big: "medium-deb.jpg"},
  {name: "Ethan Jewett", title: "Board Member", image: "small-ethan.jpg", image_big: "medium-ethan.jpg"}
])
Search.create!([
...
User.create!([
  {name: 'Scott Hillson', email: 'scott.hillson@gmail.com', password: 'brownies', admin: true, activated: false},
  {name: 'Scott Houser', email: 'pnw.scott@gmail.com', password: 'tinypeoplegiantworld', admin: true, activated: false}
])
